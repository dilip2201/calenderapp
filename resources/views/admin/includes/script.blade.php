    ...
    <script src="{{ URL::asset('public/app-assets/vendors/js/extensions/tether.min.js') }}"></script>
    <script src="{{ URL::asset('public/app-assets/vendors/js/extensions/shepherd.min.js') }}"></script>
    <!-- END: Page Vendor JS-->
    ...
    <!-- BEGIN: Page JS-->
    <script src="{{ URL::asset('public/app-assets/js/scripts/pages/dashboard-analytics.js') }}"></script>
    ...
    <script src="{{ URL::asset('public/app-assets/vendors/js/tables/datatable/datatables.min.js') }}"></script>
    ...
    <script src="{{ URL::asset('public/app-assets/vendors/js/tables/datatable/buttons.bootstrap.min.js') }}"></script>
